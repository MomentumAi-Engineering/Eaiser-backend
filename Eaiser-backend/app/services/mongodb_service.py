...
async def init_db():
    ...
    global client, db, fs
    try:
        # Optimized MongoDB client configuration for high performance
        ...
        logger.info(f"🔧 Connection pool: maxPoolSize=100, minPoolSize=10")
        logger.info(f"⚡ Performance optimizations: compression enabled, read preference set")
