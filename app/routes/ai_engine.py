...
async def analyze_image(
    ...
    try:
        ...
        if is_real:
            ...
            # classify_issue returns: issue_type, severity, confidence, category, priority, issue_detected, simi_data
            issue_type, severity, conf, category, priority, issue_detected, *_simi_extra = await classify_issue(image_content, description or "")
